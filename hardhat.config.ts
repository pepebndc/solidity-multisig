...
const config: HardhatUserConfig = {
  ...
  etherscan:
    process.env.VERIFY_MELD_AVASCAN?.toLowerCase() === "true"
      ? {
          apiKey: {
            meld: "avascan", // apiKey is not required, just set a placeholder
          },
          customChains: [
            {
              network: "meld",
              ...
              urls: {
                apiURL:
                  "https://api.avascan.info/v2/network/mainnet/evm/333000333/etherscan",
                browserURL: "https://mainnet.avascan.info/blockchain/meld",
              },
            },
          ],
        }
